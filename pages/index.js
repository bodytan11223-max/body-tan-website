    ...
    <>
      ...
      <div style={{ background: '#f8f6f3', minHeight: '100vh' }}>
        ...
        <section id="services" style={{ padding: '4rem 2rem', background: 'white' }}>
          <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
            ...
            <div style={{
              ...
              {[
                { icon: 'âï¸', title: 'Premium Tanning Beds', desc: '14 state-of-the-art beds for the perfect golden glow. Custom sessions available.' },
                { icon: 'ð', title: 'Massage Therapy', desc: 'Deep tissue, Swedish, and hot stone massages. Unwind and rejuvenate.' },
                { icon: 'ð´', title: 'Red Light Therapy', desc: 'Cutting-edge recovery and skin health. Coming soon to our Brooklyn location.' },
                { icon: 'â¨', title: 'Wellness Treatments', desc: 'Expanding our holistic wellness offerings. Comprehensive self-care in one place.' }
              ].map((service, idx) => (
                <div key={idx} style={{
                  background: '#f8f6f3',
                  padding: '2rem',
        ...
        <section id="about" style={{ padding: '4rem 2rem', background: '#f8f6f3' }}>
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <p style={{
              ...
              As wellness evolves, so do we. We're expanding beyond tanning to offer a full spectrum of treatmentsâfrom therapeutic massage to cutting-edge therapies like red light therapy. Our goal is simple: be your one-stop wellness sanctuary in the heart of Brooklyn.
            </p>
          </div>
        </section>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3rem', marginBottom: '3rem' }}>
              ...
              <div>
                ...
                <p style={{
                  ...
                  MonâThu: 10amâ8pm<br />
                  FriâSat: 10amâ9pm<br />
                  Sun: 10amâ9pm
                </p>
        ...
        <footer style={{
          ...
          <p style={{ margin: 0 }}>
            Â© 1989â2026 Body Tan. Brooklyn's premier wellness sanctuary.
          </p>
        </footer>
      </div>
    </>
